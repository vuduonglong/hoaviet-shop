...
(function (games_v1) {
    ...
    class Resource$Playergameevents {
        context;
        constructor(context) {
            this.context = context;
        }
        batchRecordEvents(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/games/v1/players/{playerId}/gameEvents:batchRecordEvents').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    games_v1.Resource$Playergameevents = Resource$Playergameevents;
