...
export declare namespace games_v1 {
    ...
    export class Resource$Playergameevents {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        batchRecordEvents(params: Params$Resource$Playergameevents$Batchrecordevents, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        batchRecordEvents(params?: Params$Resource$Playergameevents$Batchrecordevents, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BatchRecordEventsResponse>>;
        batchRecordEvents(params: Params$Resource$Playergameevents$Batchrecordevents, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        batchRecordEvents(params: Params$Resource$Playergameevents$Batchrecordevents, options: MethodOptions | BodyResponseCallback<Schema$BatchRecordEventsResponse>, callback: BodyResponseCallback<Schema$BatchRecordEventsResponse>): void;
        batchRecordEvents(params: Params$Resource$Playergameevents$Batchrecordevents, callback: BodyResponseCallback<Schema$BatchRecordEventsResponse>): void;
