...
export declare namespace retail_v2alpha {
    ...
    export interface Schema$GoogleCloudRetailV2alphaCompleteQueryResponseCompletionResult {
        /**
         * Conversational prompts to trigger agents like Shopping Agent. There may be multiple prompts for a single suggestion. This is an experimental feature for select customers. If you want to receive this prompt information, reach out to the Retail support team.
         */
        agentPrompts?: Schema$GoogleCloudRetailV2alphaCompleteQueryResponseCompletionResultAgentPrompt[];
        /**
     ...
     */
    export interface Schema$GoogleCloudRetailV2alphaCompleteQueryResponseCompletionResultAgentPrompt {
        /**
